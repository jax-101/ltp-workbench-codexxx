...
Final runtime effort was `208,093` tokens over 560 seconds. The package closed
at `54.6%` weighted project scope. No estimate outside the architecture-
governance class was revised from this observation.
